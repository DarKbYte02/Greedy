...
int main(){
	...
	auto mst_kruskal = g.kruskal();
	cout <<"Árbol de expansión mínima con Kruskal: " << endl;
	for(auto& a:mst_kruskal){
		cout << a.origen << " " << a.destino << " " << a.peso << endl;
		total1 += a.peso;
	}
	cout << total1 << endl;
	auto mst_prim = g.prim();
	cout <<"Árbol de expansión mínima con Prim: " << endl;
	for(auto& b:mst_prim){
		cout << b.origen << " "<< b.destino << " " << b.peso << endl;
		total2 += b.peso;		
	}
	cout << total2 << endl;
	return 0;
